...
char* output_board(int board[6][6]){
    char* output = "";
    for(int i=0; i<6; i++){
        for(int j=0; j<6; j++){
...
void input_board(char* board_str){
    int board[6][6];
    for(int i=0; i<6; i++){
        for(int j=0; j<6; j++){
...
void alpha_beta_pruning(int target_depth, int board[6][6], int player_color){
...
char* abp(int player_color, int depth, char* board){
    input_board(board);
    ...
    alpha_beta_pruning(depth, board, player_color);
